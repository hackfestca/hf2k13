...
mkdir -p $CHROOT/var/cache $CHROOT/var/log $CHROOT/var/run $CHROOT/var/log/named $CHROOT/var/run/named $CHROOT/var/cache/bind
chmod 770 $CHROOT/var/log/named
chmod 775 $CHROOT/var/run/named $CHROOT/var/cache/bind
chown root:bind $CHROOT/var/log/named $CHROOT/var/run/named $CHROOT/var/cache/bind
