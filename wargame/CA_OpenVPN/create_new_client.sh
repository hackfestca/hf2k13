...
# function create()
#
# Create folder structure for the script + Create cnf file for key creation
#    + zip the final package with all the required fild (Key, Crt, CA.crt, dh1024.pem)
# In : Nothing
# Return : Nothing (files in OpenVPN_Client folder)
####################
create()
{
...
EOF
  ...
  echo -e "${GREEN_COLOR}Creation of key and onfiguration completed!! ${NOCOLOR}"
